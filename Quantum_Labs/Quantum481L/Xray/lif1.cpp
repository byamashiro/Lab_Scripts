...
//====================GOES flux data
    ...
    TGraphErrors *gr1 = new TGraphErrors("lif1.dat","%lg %lg %lg %lg");
    ...
    mg->Add(gr7);
    */
    TGraphErrors *gr2 = new TGraphErrors("lif1.dat","%lg %*lg %*lg %*lg %lg %lg %lg");
...
//=================Drawing the data
    ...
    //gr3->Draw("LP");
    //gr4->Draw("LP");
    mg.SetTitle("LiF (n=1);Angle (#circ);Counts");
    //c1->BuildLegend();
