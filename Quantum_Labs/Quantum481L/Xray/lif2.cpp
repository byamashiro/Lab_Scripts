...
//====================GOES flux data
    ...
    TGraphErrors *gr1 = new TGraphErrors("lif2.dat","%lg %lg %lg %lg");
    ...
    */
    ...
    TGraphErrors *gr2 = new TGraphErrors("lif2.dat","%lg %*lg %*lg %*lg %lg %lg %lg");
...
//=================Drawing the data
    ...
    //gr3->Draw("LP");
    //gr4->Draw("LP");
    mg.SetTitle("LiF (n=2);Angle (#circ);Counts");
    //c1->BuildLegend();
