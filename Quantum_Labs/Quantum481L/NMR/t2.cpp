...
//====================GOES flux data
    ...
    TGraphErrors *gr1 = new TGraphErrors("t2.dat","%lg %lg %lg");
    gr1->SetTitle("T2");
    ...
    TF1 * f1 = new TF1("f1","[0]*exp(-(2.*x)/[1])");
    gr1->Fit("f1","R","R", 0.0001, 0.03);
    ...
    */
    ...
    /*
    TGraphErrors *gr2 = new TGraphErrors("nacl1.dat","%lg %*lg %*lg %*lg %lg %lg %lg");
...
//=================Drawing the data
    ...
    //gr3->Draw("LP");
    //gr4->Draw("LP");
    mg.SetTitle("Heavy Mineral Oil T2;Decay Time (s);Peak Voltage (V)");
    //c1->BuildLegend();
