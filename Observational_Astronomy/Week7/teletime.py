...
nPoints = len(temp_ps1)
nPoints_isp1 = len(temp_isp1)
...
magnitude = TGraph(nPoints, dtime_ps1, counts_ps1)
#magnitude.Fit("pol4")
...
magnitude.SetTitle("PS-1 Time;Dark Time [s];Mean Counts")
magnitude . Draw ( "AP" ) ;
...
#gr.Fit("gaus")
c1 . Update ()
c1.Print("time_ps1.pdf");

#------ISP1

magnitude_isp1 = TGraph(nPoints_isp1, dtime_isp1, counts_isp1)
#magnitude_isp1.Fit("pol4")
magnitude_isp1.SetMarkerStyle(2) #7
magnitude_isp1.SetMarkerColor(2)

magnitude_isp1.SetTitle("ISP-1 Time;Dark Time [s];Mean Counts")
