...
magnitude.SetTitle("PS-1 Temperature;Temperature [#circC];Mean Counts")
magnitude . Draw ( "AP" ) ;
...
magnitude_isp1 = TGraph(nPoints_isp1, temp_isp1, counts_isp1)
#magnitude_isp1.Fit("pol4")
magnitude_isp1.SetMarkerStyle(2) #7
magnitude_isp1.SetMarkerColor(2)

magnitude_isp1.SetTitle("ISP-1 Temperature;Temperature [#circC];Mean Counts")
